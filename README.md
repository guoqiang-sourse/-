...
> [!IMPORTANT]
> 本仓库是基于 [yeliqin666/xjtu-toolbox-android](https://github.com/yeliqin666/xjtu-toolbox-android) 的社区二次开发（魔改）版本，不是原项目官方发布，也未获得原作者官方背书。
> 本项目秉承开源精神进行适配、修复与进一步优化，并尊重原项目版权、名称和贡献记录；详细区别与致谢见 [README-release.md](README-release.md)。

<p align="center">
  <img src="https://img.shields.io/badge/platform-Android-green?logo=android" alt="Android" />
  <img src="https://img.shields.io/badge/minSdk-31%20(Android%2012)-blue" alt="minSdk 31" />
  <img src="https://img.shields.io/badge/version-4.9.9-orange" alt="version 4.9.9" />
